...
import { Save, RefreshCw, Database, Shield, Globe, Bell } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="custom-css" placeholder="/* Add your custom CSS here */" className="min-h-[100px]" />
                <p className="text-sm text-muted-foreground">Custom styles for your CRM interface</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
